...
// import { SysEntities, ProblemKeywords } from "../../../src/constants";
// import { ValidationProblem } from "../../../src/validation/validation-problem";
...
//             const problems = await new SchemaValidator(testEntities.simpleLinkedEntityType,
...
//             const problems = await new SchemaValidator(testEntities.complexLinkedEntityType,
//                 repositoryFactory).validate(entity);
