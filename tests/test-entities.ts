...
import { PropertyTypes, IEntityType, ILinkedProperty } from "@poseidon/core-models";
...
export class TestEntities {
     ...
     * @readonly
     */
    public get fullEntityType(): IEntityType {
        return {
            _id: "FullEntityType",
            name: "FullEntityType",
            abstract: false,
     ...
     * @readonly
     */
    public get simpleAbstractEntityType(): IEntityType {
        return {
     ...
     * @readonly
     */
    public get simpleLinkedEntityType(): IEntityType {
        return {
     ...
     * @readonly
     */
    public get complexAbstractEntityType(): IEntityType {
        return {
     ...
     * @readonly
     */
    public get complexLinkedEntityType(): IEntityType {
        return {
     ...
     * @readonly
     */
    private get simpleLinkedEntityTypeLinkedProps(): ILinkedProperty[] {
        return [
            { name: "_id" },
            { name: "stringProp" }
        ];
     ...
     * @readonly
     */
    private get complexLinkedEntityTypeLinkedProps(): ILinkedProperty[] {
        return [
            { name: "_id" },
            { name: "stringProp" },
            { name: "intProp" },
