...
class EntityRepository {
    constructor(entityType) {
        ...
        this._collection = data_connection_1.DataAccess.database.collection(entityType.name);
    }
    ...
    static getInstance(entityType) {
        ...
        if (repo) {
            ...
            repo._collection = data_connection_1.DataAccess.database.collection(entityType.name);
        }
        else {
        ...
        return new Promise((resolve, reject) => {
            ...
            validation_1.Validator.validate(this.entityType, entity, true).then(() => {
                ...
                this._collection.insertOne(entity).then((res) => {
                    ...
                    reject(new database_error_1.DatabaseError(_1.SysMsgs.error.databaseLevelError, err.message));
                });
