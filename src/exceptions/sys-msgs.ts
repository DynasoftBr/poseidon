...
export const SysMsgs = {
  ...
  error: {
    ...
    abstractEntityType: {
      code: 3003,
      message:
        "The entity type '%s' is an abstract entity type, so it cannot be used to directly instantiate a repository."
    },
  ...
  validation: {
    ...
    missingRequiredEntityProperty: {
      code: 4018,
      message:
        "The system entity '%s' are required for all entity types.\n" +
        "Poseidon adds these properties on entity type's creation. Please don't change it."
    },
    invalidRequiredEntityProperty: {
      code: 4019,
      message:
        "The system entity '%s' doesn't match the required expecification." +
        "Poseidon adds these properties on entity type's creation. Please don't change it."
    },
    invalidPattern: {
      code: 4020,
