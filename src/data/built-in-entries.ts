...
export class BuiltInEntries {
      ...
      commands: [
        {
          ...
          pipeline: [
            ...
            {
              name: "teste",
              code: "export default function setEtName(request: IRequest, next: PipelineItem){\r\n    request.payload.name = \"Pessoa\";\r\n    return next(request);\r\n}"
            }
          ]
        }
      ],
  ...
  public get entityTypeEntityProperty(): IEntityType {
    return {
      ...
      abstract: true,
      props: [this.entityPropertyNamePropertyDefinition, this.validationPropertyDefinition],
      _createdBy: this.rootUserRef,
      _createdAt: new Date()
    };
  }
