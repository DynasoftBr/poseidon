...
class EntityFactory {
    ...
    parseDefault(d, type) {
        ...
        if (type === models_1.PropertyType.string || type === models_1.PropertyType.enum)
            return parsed;
        else if (type === models_1.PropertyType.boolean)
            return new Boolean(parsed);
        else if (type === models_1.PropertyType.array)
            return [parsed];
        else if (type === models_1.PropertyType.dateTime)
            return new Date(parsed);
        else if (type === models_1.PropertyType.number)
            return Number.parseFloat(parsed);
        else if (type === models_1.PropertyType.int)
